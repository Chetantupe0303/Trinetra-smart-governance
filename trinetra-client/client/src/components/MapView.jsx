...
function MapView({ complaints = [] }) {
  ...
  return (
    <div className="mb-6 rounded-xl border border-slate-200/60 bg-white p-5 shadow-sm animate-fade-up">
      <div className="flex items-center gap-2.5 mb-4">
        <div className="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center">
          <svg className="w-4 h-4 text-indigo-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Legend */}
      <div className="mb-4 grid grid-cols-2 md:grid-cols-4 gap-3 p-3.5 bg-indigo-50/40 rounded-xl border border-indigo-100/70">
        ...
        <div className="flex items-center gap-2">
          <div style={{width: "12px", height: "12px", borderRadius: "50%", backgroundColor: "#3730A3", border: "2px solid #fff", boxShadow: "0 0 0 2px #3730A3"}}></div>
      ...
      <div className="h-[360px] overflow-hidden rounded-xl border border-slate-200/60">
